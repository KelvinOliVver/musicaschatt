...
import { CyberpunkBackdrop } from "@/components/CyberpunkBackdrop";
...
function PlayerPage() {
  ...
  // a cor dominante da capa atual — usados pra alimentar o fundo cyberpunk
  // que cobre a página inteira (não só o painel do player).
  ...
  return (
    <main className="relative z-0 mx-auto flex min-h-screen w-full max-w-[1600px] flex-col gap-4 overflow-hidden p-4">
      <CyberpunkBackdrop isPlaying={isCurrentlyPlaying} accentColor={accentColor} />
