...
export function PlayerPanel({
  ...
  // ============================================================
  // TESTE DE DIAGNÓSTICO: heartbeat de playback temporariamente
  // DESATIVADO (o "return;" logo no início interrompe o efeito
  // antes de criar o intervalo). Isso serve só para descobrir se
  // o engasgo de áudio/vídeo tem relação com essa gravação
  // periódica no banco. Depois do teste, remova a linha
  // "return;" para reativar o heartbeat normalmente.
  // ============================================================
  useEffect(() => {
    return; // <-- TESTE: heartbeat desativado temporariamente
